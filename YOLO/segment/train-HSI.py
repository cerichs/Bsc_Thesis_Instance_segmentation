...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if pretrained:
        ...
        model = SegmentationModel(cfg or ckpt['model'].yaml, ch=102, nc=nc, anchors=hyp.get('anchors')).to(device)
        ...
        model = SegmentationModel(cfg, ch=102, nc=nc, anchors=hyp.get('anchors')).to(device)  # create
